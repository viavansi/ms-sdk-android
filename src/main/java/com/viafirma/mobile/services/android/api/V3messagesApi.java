...
import com.viafirma.mobile.services.android.model.ValidateCodeEdit;
...
public class V3messagesApi {
  ...
  public Message editValidation (ValidateCodeEdit body) throws ApiException {
    Object postBody = body;
    

    // create path and map variables
    String path = "/v3/messages/editValidation".replaceAll("\\{format\\}","json");
  ...
  public Message validateOtpMail (String messageCode, String token, String setCode, String recipientKey) throws ApiException {
    ...
    // create path and map variables
    String path = "/v3/messages/otp/mail/validate".replaceAll("\\{format\\}","json");
  ...
  public OtpInfo prepareOtpSms (String messageCode, String setCode, String recipientKey) throws ApiException {
    ...
    // create path and map variables
    String path = "/v3/messages/otp/sms/prepare/{messageCode}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "messageCode" + "\\}", ApiInvoker.getInstance().escapeString(messageCode.toString()));
  ...
  public Message validateOtpSms (String messageCode, String token, String setCode, String recipientKey) throws ApiException {
    ...
    // create path and map variables
    String path = "/v3/messages/otp/sms/validate".replaceAll("\\{format\\}","json");
