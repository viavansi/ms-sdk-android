...
public class V3templateApi {
  ...
  public List<TemplateList> findAllTemplatesByUserAndGroup (String groupCode, String userCode) throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/v3/template/all/{groupCode}/{userCode}".replaceAll("\\{format\\}","json")
  ...
  public List<TemplateList> findTemplatesByUserAndGroupWithFormAndTemplate (String groupCode, String userCode) throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/v3/template/allComplete/{groupCode}/{userCode}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "groupCode" + "\\}", ApiInvoker.getInstance().escapeString(groupCode.toString()))
      .replaceAll("\\{" + "userCode" + "\\}", ApiInvoker.getInstance().escapeString(userCode.toString()));
  ...
  public List<TemplateList> findMyTemplates () throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/v3/template/list/mine".replaceAll("\\{format\\}","json");
  ...
  public List<TemplateList> findMyGroupTemplates (String groupCode) throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/v3/template/list/mine/{groupCode}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "groupCode" + "\\}", ApiInvoker.getInstance().escapeString(groupCode.toString()));
