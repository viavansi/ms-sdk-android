...
import com.viafirma.mobile.services.android.model.JSMati;
...
public class V3matiApi {

  private static final V3matiApi INSTANCE = new V3matiApi();
  private V3matiApi(){}
  public static V3matiApi getInstance() {
    return INSTANCE;
  }
