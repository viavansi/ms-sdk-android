...
import com.viafirma.mobile.services.android.model.GroupUserData;
import com.viafirma.mobile.services.android.model.Client;
...
public class V3systemApi {
  ...
  public String createApp (GroupUserData body) throws ApiException {
    ...
    // create path and map variables
    String path = "/v3/system/app".replaceAll("\\{format\\}","json");
  ...
  public String createClient (Client body) throws ApiException {
    Object postBody = body;
    

    // create path and map variables
    String path = "/v3/system/client".replaceAll("\\{format\\}","json");
  ...
  public String getGlobalMessage () throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/v3/system/globalMessage".replaceAll("\\{format\\}","json");
